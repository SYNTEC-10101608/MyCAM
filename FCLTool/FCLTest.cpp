...
public:
	void AddModel( const std::string &szID,
	...
	bool CheckCollision( const std::string &szID1, const std::string &szID2,
...
private:
	Transform3f CreateTransform( const double *const trsf ) {
		Matrix3f R;
		Vector3f T;
	...
	std::unordered_map<std::string, std::shared_ptr<BVHModel<OBBRSSf>>> m_ModelMap;
};
