...
namespace MyCAM.Manufactor
{
	internal static class LeadManufactor
	{
		...
		public static List<gp_Pnt> Get2PntSegmentPnt( gp_Pnt currentPnt, gp_Pnt nextPnt, double stepLength )
		{
		...
		public static void GetCurveSegmentPointsWithTangent( Geom_TrimmedCurve curve, gp_Pnt circleCenter, gp_Dir circleNormal, out List<gp_Pnt> pointList, out List<gp_Dir> tangentList, double dDeflection, double dMaxLength )
		{
