namespace MyCAM.Editor.Dialog
{
	partial class AutoSortPathDlg
	{
		...
		protected override void Dispose( bool disposing )
		{
			...
			if( disposing ) {
				m_imgExtrusionFirst_FromTop_Clockwise?.Dispose();
				m_imgExtrusionFirst_FromTop_Counterclockwise?.Dispose();
				m_imgExtrusionFirst_FromBottom_Clockwise?.Dispose();
				...
				m_imgRotationFirst_FromBottom_Clockwise?.Dispose();
				m_imgRotationFirst_FromBottom_Counterclockwise?.Dispose();
			}
		...
		private void InitializeComponent()
		{
			...
			this.m_lblExtrusionDir.Location = new System.Drawing.Point( 19, 52 );
			...
			this.m_cmbExtrusionDir.Location = new System.Drawing.Point( 100, 49 );
			...
			this.m_picPreview.Location = new System.Drawing.Point( 19, 108 );
			...
			this.m_btnConfirm.Location = new System.Drawing.Point( 184, 457 );
			...
			this.ClientSize = new System.Drawing.Size( 265, 492 );
