...
//				return;
//			}
//			ToShapeDataDTO( dataManager.ObjectMap );
...
//			ContourCacheInfo camData = CAMData.ToCAMData();
...
//		internal CAMDataDTO( ContourCacheInfo camData )
//		{
//			if( camData == null ) {
//				return;
//			}
...
//			StartPoint = camData.StartPointIndex;
...
//		internal ContourCacheInfo ToCAMData()
//		{
...
//			return new ContourPathObject( cadPoints, IsClosed, StartPoint, leadParam, IsReverse, IsToolVecReverse, OverCutLength, toolVecModifyMap, traverseData );
//		}
//	}
